...
//        mDividerHeight=dip2px(context,0.5f);
        mDividerHeight=mDivider.getIntrinsicHeight();
        Log.d("RecyclerViewDivider","mDividerHeight="+mDividerHeight);
    }
    ...
    public int dp2px(Context context,int dpValue){
        // 获得转换后的px值
        float pxDimension = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, dpValue,context.getResources().getDisplayMetrics());
